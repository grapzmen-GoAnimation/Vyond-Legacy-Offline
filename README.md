...
## Instalation
if it's module not found on the npm thing, type npm install and enter, it is best if you use the [vyond legacy offline installer](https://github.com/grapzmen-GoAnimation/Vyond-Legacy-Offline-Installer). that gets rid of pain of having to wait for the files to extract and everything.
...
## What happens if you don't use the installer to get Vyond Legacy Offline?
it doesn't update
